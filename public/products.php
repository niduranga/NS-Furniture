                ...
                <div class="col-12 col-md-4 product-card" data-category="sofas">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="../index.php?page=login" class="btn btn-warning add-to-cart"
                                data-name="Luxury Sofa" data-price="499"><i class="fas fa-cart-plus"></i> Add to
                                Cart</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4 product-card" data-category="chairs">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="../index.php?page=login" class="btn btn-warning add-to-cart"
                                data-name="Wooden Chair" data-price="199"><i class="fas fa-cart-plus"></i> Add to
                                Cart</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4 product-card" data-category="tables">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="../index.php?page=login" class="btn btn-warning add-to-cart"
                                data-name="Dining Table" data-price="799"><i class="fas fa-cart-plus"></i> Add to
                                Cart</a>
                        </div>
                    </div>
                </div>
